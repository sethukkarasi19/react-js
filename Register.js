    ...
    render() {
        ...
        if(userRole === 'applicant') {
            ...
            <div>
                ...
                />
                <br></br>
                <label htmlFor="">Resume</label><br></br>
        ...
        return (
            <div className="container">
                <div className="row">
                    ...
                    <div className="col s8 offset-s2">
                    <img src="https://img.freepik.com/free-vector/recruit-agent-analyzing-candidates_74855-4565.jpg?w=2000" height="500" width="700"></img>
                        </div>
                </div>
            </div>
        );
