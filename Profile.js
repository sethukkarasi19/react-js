...
class Profile extends Component {
  ...
  delEducation(ed) {
    ...
    this.state.userdetails.education = this.state.userdetails.education.filter(
      (item) => item._id !== idToRemove
    );
    axios
      .put(
        "http://localhost:4000/user/edit_profile/" + user.id,
  ...
  editEducationSubmit(ed) {
    ...
    this.setState({ editing: "" });
    const ind = this.state.userdetails.education.findIndex(
      (x) => x._id === idToChange
    );
      ...
      UserDetails = (
        <div>
          ...
          <ul>
            <li>
              ...
              <Tooltip title="Add Education" aria-label="added">
                <Link
                  style={{ color: "#009900", weight: "bold" }}
                  to="/addeducation"
                >
                  ...
                  <li>
                    <ul>
                      ...
                      <li>
                        Start date:{" "}
                        {ed.startdate
                          ? ed.startdate.toString().substring(0, 10)
                          : "NA"}
                      </li>
                      <li>
                        End date:{" "}
                        {ed.enddate
                          ? ed.enddate.toString().substring(0, 10)
                          : "NA"}
                      </li>
                    </ul>
          ...
          <ul>
            <li>
              Resume:
              {this.state.userdetails.resume ? (
                <a
                  style={{ marginLeft: "15px" }}
                  href={
                    this.state.userdetails.resume
                      ? `http://localhost:4000/testAPI/download/${this.state.userdetails.resume}`
                      : "#"
                  }
                  target="_blank"
                >
                ...
                <label htmlFor="resume" style={{ marginLeft: "15px" }}>
                  Upload your resume in edit page
                </label>
              )}
            </li>
          </ul>
        ...
        <div className="row">
          <div className="col s12 center-align">
            <Card style={{ width: "100%" }}>
              ...
              <Card.Body>
                <Card.Title>
                <img src="https://static1.shine.com/l/m/images/blog/job_search_portals.png" width="1050" height="500"></img>
                  <p>
                    <b>{user.name}: </b>
                ...
                <Card.Text>{UserDetails}</Card.Text>
              </Card.Body>
            </Card>
          </div>
        </div>
